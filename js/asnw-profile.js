(function (global) {
  ...
  const FLAG_DEFS = [
    ...
    {
      key: "numbersFlowToQ",
      storageKey: "asnwNumbersFlowToQ",
      label: "flux numere spre ?",
      cssClass: null,
      implemented: true,
    },
    {
      key: "onboardingPersist",
      storageKey: "asnwOnboardingPersist",
      label: "Onboarding persistent (nu doar 3 zile)",
      cssClass: null,
      implemented: true,
    },
    {
